...
Castellon Provincial Council (OVRc).

Notes
=====
After installation, it is mandatory to create a payment mode called 'OVRc' associated with the
payment method 'Castellon Collection Office of Valencia (OVRc)'.
